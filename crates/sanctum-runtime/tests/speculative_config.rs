use sanctum_runtime::speculative::{
    ContextCapacity, DecoderConfig, DraftModel, ParameterCount, TargetModel,
};
#[test]
fn preserves_capacity() {
    let c = DecoderConfig {
        ...
        capacity: ContextCapacity::new(32).unwrap(),
    };
    assert_eq!(c.capacity.get(), 32);
}
