use sanctum_runtime::tui::{
    ActiveProfile, CpuTelemetry, DashboardSnapshot, KvResidency, MemoryBytes, MemoryTelemetry,
    TokenRate, Utilization,
};
#[test]
fn constructs_snapshot() {
    let s = DashboardSnapshot::new(
        TokenRate::new(42.0).unwrap(),
    ...
    assert_eq!(s.profile.as_str(), "focused");
}
